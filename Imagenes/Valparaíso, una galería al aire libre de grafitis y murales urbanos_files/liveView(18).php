		...
		return new Promise((resolve) => {
			...
			if (this.isAmpProject || this.isAmpIframe) {
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=115792&cbuster=818949510&cbuster=1715380655',
					origQString: 's=115792&cbuster=818949510',
					placementId: 115792,
					x: 600,
					y: 338,
					videoType: 'flow',
